...
class Grid2DIterate(Grid2D):
    ...
    def from_mask(
        ...
        return Grid2DIterate(
            grid=grid_slim,
            mask=mask.derived_masks.mask_sub_1,
            fractional_accuracy=fractional_accuracy,
            relative_accuracy=relative_accuracy,
            sub_steps=sub_steps,
        )
    ...
    def return_iterated_array_result(self, iterated_array: Array2D) -> Array2D:
        ...
        return Array2D(array=iterated_array_1d, mask=self.mask.derived_masks.mask_sub_1)
    ...
    def iterated_grid_from(
        ...
        for sub_size in self.sub_steps[:-1]:
            ...
            if threshold_mask_higher_sub.is_all_true:
                ...
                return Grid2D(
                    grid=iterated_grid_1d, mask=self.mask.derived_masks.mask_sub_1
                )
        ...
        return Grid2D(grid=iterated_grid_1d, mask=self.mask.derived_masks.mask_sub_1)
