...
class Array2D(abstract_array.AbstractArray2D):
    ...
    def manual_slim(
        ...
        array = abstract_array.convert_manual_array_slim(
    ...
    def manual_native(
        ...
        array = abstract_array.convert_manual_native_array(
            array_2d=array, mask=mask, store_slim=store_slim
        )
    ...
    def manual_mask(cls, array, mask, exposure_info=None, store_slim=True):
        ...
        array = abstract_array.convert_manual_array(
            array=array, mask=mask, store_slim=store_slim
        )
        return cls(
            array=array, mask=mask, exposure_info=exposure_info, store_slim=store_slim
        )
    ...
    def manual_yx_and_values(
        ...
        grid = grids.Grid2D.manual_yx_1d(
