...
def mapping_matrix_Delaunay_bilinear_interpolation_from(
    ...
    for sub_slim_index in range(slim_index_for_sub_slim_index.shape[0]):
        ...
        if neighbor_triangle_id != -1:
            ...
            neighbor_triangle_veritces_coordinates = relocated_pixelization_grid[neighbor_triangle_veritces_ids]
            ...
            mapping_matrix[slim_index_for_sub_slim_index[sub_slim_index]][neighbor_triangle_veritces_ids] += sub_fraction * weight_abc
