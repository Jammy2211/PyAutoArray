...
def curvature_matrix_off_diags_via_w_tilde_curvature_preload_imaging_linear_func_from(
    ...
    data_pixels = data_weights_0.shape[0]
        ...
        for pix_0_index in range(pix_lengths_0[data_0]):
            ...
            for linear_index in range(linear_func_pixels):
                ...
                curvature_matrix[pix_0, linear_index] += (
                    data_0_weight * linear_func_values[data_0, linear_index]
                )
...
def curvature_matrix_diags_via_w_tilde_curvature_preload_imaging_linear_func_x2_from(
    ...
    curvature_matrix = np.zeros((linear_func_pixels, linear_func_pixels))
    ...
    for data_0 in range(data_pixels):
        ...
        for data_1_index in range(curvature_lengths[data_0]):
            ...
            for pix_linear_func_index_0 in range(linear_func_pixels):

                for pix_linear_func_index_1 in range(linear_func_pixels):

                    curvature_matrix[
                        pix_linear_func_index_0, pix_linear_func_index_1
                    ] += (
                        linear_func_values[data_0, pix_linear_func_index_0]
                        * linear_func_values[data_1, pix_linear_func_index_1]
                        * w_tilde_value
                    )
