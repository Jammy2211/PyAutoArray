...
e.g. add a line to ~/.bashrc like "export export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/your/path/to/autoarray/nn_tools/nn_c_sources/nn"
...
This command is to cover the automatically generated makefile. 
