...
void nnhpi_interpolate_get_weights(nnhpi* nn, point* p, double* weights_out, int* neighbor_index, int max_nneighbor, int point_index);

int nnhpi_interpolate_output_marker(nnhpi* nn, point* p);
