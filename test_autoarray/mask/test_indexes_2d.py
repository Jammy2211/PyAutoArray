...
def test__border_1d_indexes():
    ...
    assert indexes_2d.border_1d_indexes == pytest.approx(border_pixels_util, 1e-4)
    assert indexes_2d.border_1d_indexes.shape[0] == indexes_2d.border_2d_indexes.shape[0]

def test__border_2d_indexes():
    mask = aa.Mask2D.manual(
        mask=[
            [True, True, True, True, True, True, True, True, True],
            [True, False, False, False, False, False, False, False, True],
    ...
    assert indexes_2d.border_2d_indexes[0] == pytest.approx(np.array([1, 1]), 1e-4)
    assert indexes_2d.border_2d_indexes[10] == pytest.approx(np.array([3, 7]), 1e-4)