...
def test__pix_indexes_for_sub_slim_index__matches_util(grid_2d_7x7):
    ...
    source_mesh_grid = aa.Grid2D.manual_slim(
    ...
    source_mesh_grid = aa.Mesh2DVoronoi(
    ...
    pix_indexes_for_sub_slim_index_util = np.array(
        [
            aa.util.mapper.pix_indexes_for_sub_slim_index_voronoi_from(
                grid=grid_2d_7x7,
                nearest_pixelization_index_for_slim_index=source_mesh_grid.nearest_pixelization_index_for_slim_index,
                slim_index_for_sub_slim_index=grid_2d_7x7.mask.slim_index_for_sub_slim_index,
                mesh_grid=source_mesh_grid,
                neighbors=source_mesh_grid.neighbors,
                neighbors_sizes=source_mesh_grid.neighbors.sizes,
            ).astype("int")
        ]
    ).T
