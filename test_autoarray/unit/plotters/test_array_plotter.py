...
class TestArrayPlotter:
    ...
    def test__plotter_inputs_inherit_from_abstract_class(self):
        ...
        plotter = aa.plotter.array(figsize=(6,6), aspect="auto", cmap="cold", norm="log", norm_min=0.1, norm_max=1.0,
                                   ...
                                   include_origin=False, include_mask=False, include_border=True, include_points=False,
                                   label_title="OMG", label_yunits="hi", label_xunits="hi2", label_yticks=[1.0, 2.0],
                                   label_xticks=[3.0, 4.0], cb_tick_values=[5.0, 6.0],
                                   cb_tick_labels=[7.0, 8.0], output_path="Path", output_format="png", output_filename="file"
                                   )
    ...
    def test__new_plotter_with_labels_and_filename(self):
        ...
        plotter = plotter.plotter_with_new_labels_and_filename(label_title="a", label_yunits="b", label_xunits="c", output_filename="d")
