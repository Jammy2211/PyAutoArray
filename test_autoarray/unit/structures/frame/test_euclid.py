...
class TestMaskedFrameAPI:
    def test__euclid_frame_for_four_quandrants__loads_data_and_dimensions(
        ...
        euclid_frame = aa.MaskedFrameEuclid.top_left(array=euclid_data, mask=mask)
        ...
        euclid_frame = aa.MaskedFrameEuclid.top_right(array=euclid_data, mask=mask)
        ...
        euclid_frame = aa.MaskedFrameEuclid.bottom_left(array=euclid_data, mask=mask)
        ...
        euclid_frame = aa.MaskedFrameEuclid.bottom_right(array=euclid_data, mask=mask)
    ...
    def test__left_side__chooses_correct_frame_given_input(self, euclid_data):
        ...
        frame = aa.MaskedFrameEuclid.from_ccd_and_quadrant_id(
