...
def test__all_imaging_data_types_are_output(
    ...
    aa.data_plotters.plot_signal_to_noise_map(
    ...
    aa.data_plotters.plot_absolute_signal_to_noise_map(
    ...
    aa.data_plotters.plot_potential_chi_squared_map(
...
def test__all_interferometer_data_types_are_output(
    ...
    aa.data_plotters.plot_visibilities(
    ...
    aa.data_plotters.plot_u_wavelengths(
    ...
    aa.data_plotters.plot_v_wavelengths(
        uv_wavelengths=uv_wavelengths_7,
        output_path=data_plotter_path,
        output_format="png",
    )
    ...
    aa.data_plotters.plot_primary_beam(
