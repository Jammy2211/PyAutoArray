...
aplt.rectangular_mapper(mapper=rectangular_mapper, image_pixel_indexes=[0, 1])
aplt.rectangular_mapper(mapper=rectangular_mapper, image_pixel_indexes=[[0, 1]])
aplt.rectangular_mapper(mapper=rectangular_mapper, image_pixel_indexes=[[0, 1], [2]])
aplt.rectangular_mapper(mapper=rectangular_mapper, image_pixel_indexes=[[(0,0), (0,1)], [(1,2)]])