...
#aplt.rectangular_mapper(mapper=rectangular_mapper, source_pixel_indexes=[0, 1])
aplt.rectangular_mapper(mapper=rectangular_mapper, source_pixel_indexes=[[0, 1]])
aplt.rectangular_mapper(mapper=rectangular_mapper, source_pixel_indexes=[[0, 1], [2]])