...
aplt.voronoi_mapper(mapper=voronoi_mapper, image_pixel_indexes=[3, 4])
aplt.voronoi_mapper(mapper=voronoi_mapper, image_pixel_indexes=[[3, 4]])
aplt.voronoi_mapper(mapper=voronoi_mapper, image_pixel_indexes=[[3, 4], [6]])
aplt.voronoi_mapper(
    mapper=voronoi_mapper, image_pixel_indexes=[[(0, 0), (0, 1)], [(2, 2)]]
)
