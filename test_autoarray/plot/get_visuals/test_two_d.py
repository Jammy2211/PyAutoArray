...
def test__via_mask_from(mask_2d_7x7):
    ...
    assert (visuals_2d_via.border == mask_2d_7x7.derived_grids.border_grid_sub_1.binned).all()
...
def test__via_mapper_for_data_from(voronoi_mapper_9_3x3):
    ...
    assert (
        ...
        == voronoi_mapper_9_3x3.source_plane_data_grid.mask.derived_grids.border_grid_sub_1.binned
    ).all()
...
def test__via_fit_imaging_from(fit_imaging_7x7):
    ...
    assert (
        visuals_2d_via.border == fit_imaging_7x7.mask.derived_grids.border_grid_sub_1.binned
    ).all()
    assert visuals_2d_via.vectors == 2
